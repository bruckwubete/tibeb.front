...
export class EtmdbRegisterComponent {
  ...
  register(): void {
    ...
    this.submitted = true;
    this.user.profilePic = this.user.filesToUpload[0]
  ...
  fileChangeEvent(fileInput: any) {
    this.user.filesToUpload = <Array<File>>fileInput.target.files;
